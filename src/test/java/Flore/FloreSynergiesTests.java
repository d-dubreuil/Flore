...
class FloreSynergiesTests {
	...
	void sontEllesAmies() {
		...
		////Température////
		/////////////////////////
		if (tempFlore1.size()==1 && tempFlore2.size()==1 && !tempFlore1.isEmpty() && !tempFlore2.isEmpty()) {
		...
		////Vent////
		/////////////////////////
		if (ventFlore1.size()<=1 && ventFlore2.size()<=1 && !ventFlore1.isEmpty() && !ventFlore2.isEmpty())	{
		...
		for (Caracteristique carac : ensolFlore1) {
			for (Caracteristique carac2 : ensolFlore2) {
				...
				else if ((ensolFlore1.size()==1 && ensolFlore2.size()==1 && !ensolFlore1.isEmpty() && !ensolFlore2.isEmpty()) && !carac2.getValeur().equals(carac.getValeur()) ) {
					
					caracBonusNegatif.add(carac);
					caracBonusNegatif2.add(carac2);
					
					System.out.println(
							"La carac " + carac.getNom() + " est négative car les deux plantes ont besoin d'ensoleillement différents.");
				}
		...
		for (Caracteristique carac : pHFlore1) {
			for (Caracteristique carac2 : pHFlore2) {
				...
				else if ((pHFlore1.size()==1 && pHFlore2.size()==1 && !pHFlore1.isEmpty() && !pHFlore2.isEmpty()) && !carac2.getValeur().equals(carac.getValeur()) ) {
					
					caracBonusNegatif.add(carac);
					caracBonusNegatif2.add(carac2);
					
					System.out.println(
							"La carac " + carac.getNom() + " est négative car les deux plantes ont besoin de pH différents.");
				}
